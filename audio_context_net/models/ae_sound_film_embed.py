...
class net(nn.Module):
    def __init__(self, embedding_size):
        ...
        self.en_2 = FiLMBlock(64, 64, embedding_size, embedding_size)
        self.en_3 = FiLMBlock(64, 8, embedding_size, embedding_size)
        self.de_1= FiLMBlock(8, 64, embedding_size, embedding_size)
        self.de_2 = FiLMBlock(64, 64, embedding_size, embedding_size)
